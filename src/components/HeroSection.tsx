  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-black overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute top-3/4 right-1/4 w-72 h-72 bg-gray-300 rounded-full mix-blend-multiply filter blur-xl"></div>
      </div>

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
            Transforme Seu <span className="text-gray-300">VGV</span> Em
            <br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 max-w-4xl mx-auto">
            <div className="bg-gray-800/60 backdrop-blur-sm border border-gray-700 rounded-xl p-6">
              ...
              <div className="text-gray-400">Em VGV Gerado</div>
            </div>
            <div className="bg-gray-800/60 backdrop-blur-sm border border-gray-700 rounded-xl p-6">
              <div className="flex items-center justify-center mb-3">
            ...
            <div className="bg-gray-800/60 backdrop-blur-sm border border-gray-700 rounded-xl p-6">
              ...
              <div className="text-gray-400">Não Promessas</div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              size="lg"
              className="bg-white text-gray-900 hover:bg-gray-100 px-8 py-4 rounded-lg font-bold text-lg transition-all duration-300"
            ...
            <Button 
              variant="outline"
              size="lg"
              className="border-2 border-gray-400 text-gray-300 hover:bg-gray-800 hover:text-white px-8 py-4 rounded-lg font-bold text-lg transition-all duration-300"
              onClick={() => {
          ...
          <div className="mt-12 max-w-3xl mx-auto">
            <blockquote className="text-lg text-gray-400 italic border-l-4 border-gray-600 pl-6">
              "Constância vence carisma. Você não precisa ser criativo, precisa ser constante."
            </blockquote>
            <cite className="text-gray-500 text-sm mt-2 block">- Arielton Pires</cite>
          </div>
