      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-blue-900 mb-6">
            Sobre <span className="text-blue-700">VGV Scale</span>
          </h2>
          <p className="text-xl text-blue-800 max-w-4xl mx-auto leading-relaxed">
            ...
            a VGV Scale é o contraste. Uma presença firme, direta e incômoda — no melhor sentido da palavra.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
          <div>
            ...
            <p className="text-lg text-blue-800 mb-6 leading-relaxed">
              Somos a verdade que o corretor precisa ouvir. É a estrutura que falta nas redes. 
              É o posicionamento onde só existe improviso.
            </p>
            <p className="text-lg text-blue-800 mb-8 leading-relaxed">
              Nossa marca não nasce da teoria, mas da prática. Não do palco, mas da rua.
              Formamos profissionais com visão estratégica, autoridade real e mentalidade de dono.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {principles.map((principle, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg border border-blue-200">
                <div className="bg-blue-800 rounded-lg w-12 h-12 flex items-center justify-center mb-4">
                  <principle.icon className="w-6 h-6 text-white" />
                </div>
                <h4 className="text-lg font-semibold text-blue-900 mb-3">{principle.title}</h4>
                <p className="text-blue-700 text-sm">{principle.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-blue-200">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-blue-800 max-w-3xl mx-auto">
              A VGV Scale representa um movimento de clareza, postura e constância. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-blue-800 mb-2">Clareza</div>
              <div className="text-blue-600">Não promessas vazias</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-blue-800 mb-2">Coragem</div>
              <div className="text-blue-600">Para se posicionar</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-blue-800 mb-2">Constância</div>
              <div className="text-blue-600">Que vence carisma</div>
            </div>
          </div>
        </div>
      </div>
